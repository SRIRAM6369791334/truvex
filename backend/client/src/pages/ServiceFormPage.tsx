          ...
          <section className="bento-card">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <label htmlFor="service-gallery">
                <span className="tw-label">Gallery images (800×600, up to 10)</span>
            ...
            {(mainPreview || service.image) && (
              <div className="image-thumbs mt-3">
                ...
                <img alt="Main service preview" src={getImageUrl(mainPreview || service.image)} />
              </div>
            )}
            <div className="image-thumbs flex flex-wrap gap-4 mt-4">
              ...
              {service.images?.map((image, index) => (
                <div key={`existing-${image}`} className="thumb-wrapper">
                  <img alt="Service gallery existing" src={getImageUrl(image)} />
                  <button
              ...
              {galleryPreviews.map((image, index) => (
                <div key={`new-${image}`} className="thumb-wrapper">
                  <img alt="Service gallery preview" src={getImageUrl(image)} />
                  <button
        ...
        <div className="space-y-8">
          ...
          <section className="bento-card">
            ...
            <div className="space-y-5">
              <label htmlFor="service-price"><span className="tw-label">Price (₹)</span><input className="tw-input" id="service-price" min="0" onChange={(event) => setService({ ...service, price: event.target.value === '' ? '' : Number(event.target.value) })} step="0.01" type="number" value={service.price} /></label>
              <label htmlFor="service-unit"><span className="tw-label">Price Unit</span><input className="tw-input" id="service-unit" onChange={(event) => setService({ ...service, price_unit: event.target.value })} value={service.price_unit} /></label>
              <label htmlFor="service-moq"><span className="tw-label">Minimum Order Quantity</span><input className="tw-input" id="service-moq" min="1" onChange={(event) => setService({ ...service, moq: Number(event.target.value) })} type="number" value={service.moq} /></label>
              <label htmlFor="service-delivery"><span className="tw-label">Delivery Info</span><input className="tw-input" id="service-delivery" onChange={(event) => setService({ ...service, delivery_info: event.target.value })} value={service.delivery_info} /></label>
            </div>
          </section>
