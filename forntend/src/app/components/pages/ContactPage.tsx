              ...
              <div className="md:col-span-2 group relative overflow-hidden rounded-none bg-white border-2 border-border p-8 md:p-10 shadow-sm hover:border-primary transition-all duration-300">
                 <div className="relative z-10">
                   ...
                   <div className="flex flex-wrap gap-4">
                     <a href="tel:+919876543210" className="inline-flex items-center justify-center gap-5 rounded-none bg-primary px-6 py-4 text-sm font-bold uppercase tracking-wider text-white hover:bg-accent hover:text-primary transition-colors active:scale-95">
                        <Phone size={18} /> 98765 43210
                     </a>
